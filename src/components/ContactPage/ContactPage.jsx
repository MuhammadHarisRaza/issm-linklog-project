...
const ContactPage = () => {
  return (
    <div >
        <div className="flex items-end justify-end bg-center bg-cover  bg-gray  overflow-hidden relative w-full py-10 px-40 pt-20 mt-10">
            <div className={`flex flex-1 flex-col  my-2 justify-around overflow-hidden relative`}>
                ...
                <div className="px-2 pt-4 pb-2 w-[110%]  flex flex-row">
                    {
