...
const OfficeInfo = ({data}) => {
  ...
  return (
    <div className="flex justify-between flex-row mx-10 px-1  py-12 bg-center bg-cover rounded-[20px]   max-w-[370px] ">
        <div className="max-w-sm rounded overflow-hidden  bg-white border-t-4 border-black p-5">
