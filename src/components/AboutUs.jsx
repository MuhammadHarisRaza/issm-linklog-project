...
const AboutUs = ({data}) => {
  ...
  return (
    <div className={`flex flex-1 ${flexStyle} my-2 md:max-w-none w-full justify-around overflow-hidden relative`}>
        ...
        <div className="flex-1 flex-col pt-2 md:mx-10 mx-0 relative">
