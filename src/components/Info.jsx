...
const Info = () => {
  return (
    <div className="flex md:flex-row flex-col-reverse overflow-hidden relative mx-5 md:my-10 my-0">
      <div className="flex-1 flex-col  px-10 relative border-2 rounded-tl-[100px] border-golden">
        <p className=" pl-[6rem] pt-10 font-poppins font-semibold text-3xl">{INFO_TITLE}</p>
      ...
      <div className={`flex-1 flex  justify-center items-center  relative border-2 rounded-br-[100px]   border-golden`}>
        <img src={info} alt="billing" className=" bg-cover relative z-[5]  rounded-br-[100px] " />
      </div>
    </div>
  )
}
